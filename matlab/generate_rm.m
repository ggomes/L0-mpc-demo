function [] = generate_rm(config_file,out_file,up_or_down,gain_value,queue_limit,controller_type)
...
switch controller_type
    ...
    case 'adjoint'
        ...
        a_controller.parameters.parameter(2).ATTRIBUTE.value = 60;
        ...
        a_controller.feedback_sensors.feedback_sensor = nan; %<--How to automatically remove this in XML ???
...
if strcmp(controller_type,'IRM_ALINEA')
for i=1:num_onramps
...
if strcmp(controller_type,'adjoint')
for i=1:num_onramps
